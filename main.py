...
from _not_currently_in_use.sensitivity_analysis import SensitivityAnalyzer
            ...
            if successful_results:
                ...
                if plot_choice == "y":
                    ...
                    try:
                        ...
                        analyzer.plot_2d_custom(
                            "variation_pct",
                            "final_cost",
                            title="Cost vs Parameter Variation",
                        )
                        analyzer.plot_3d_custom(
                            "final_cost",
                            "improvement_pct",
                            "barge_utilization_pct",
...
def main():
    ...
    print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n")
    print("Container Allocation Optimization Project")
    print("=" * 60)
    ...
    continue_choice = (
        "no"  # +#+# Disabled for now, because we don't have that template.
    )
